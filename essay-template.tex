...
\fancyhead[L]{\ifnum\value{page}>1 \footnotesize{\textsc{\flushleft{Essay Template}}} \fi}
\fancyhead[R]{\ifnum\value{page}>1 \footnotesize{\textsc{\flushright{Page \thepage}}} \fi}


% \fancyhead[C]{\footnotesize{\textsc{Essay Template}}}
\fancyfoot[L] {\ifnum\value{page}>1 \footnotesize{\textsc{$\copyright$ \hspace{.02cm} David Witus (2024)}} \fi}
% \fancyfoot[C]{\footnotesize{--~\thepage~--}}
\fancyfoot[R]{\ifnum\value{page}>1 \footnotesize{\textsc{ All rights reserved}}  \fi}

\title{\Large{Essay Template}\\
\vspace*{.75em}
\large{For personal use only}\\
\vspace*{.75em}
\small\textit{Do not share this for now.}}
\author{\large{by David Witus}}
\date{}
